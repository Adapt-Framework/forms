...
namespace adapt\forms{
    ...
    class view_field_file extends view_form_page_section_group_field{
        ...
        public function __construct($form_data, $data_type, &$user_data){
            ...
            if (isset($form_data['label']) && trim($form_data['label']) != ''){
                $this->add(new html_label($form_data['label'], array('for' => $control->attr('id'), 'class' => 'control-label field-label')));
            }
