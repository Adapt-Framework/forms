...
namespace extensions\forms{
    ...
    class view_field_input extends \extensions\bootstrap_views\view_form_group{
        
        public function __construct($values = array()){
            $control = new \extensions\bootstrap_views\view_input("text", $values['name'], $values['value'], $values['placeholder_label']);
