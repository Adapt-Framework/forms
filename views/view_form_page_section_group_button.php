...
namespace adapt\forms{
    ...
    class view_form_page_section_group_button extends view{
        
        public function __construct($form_data, $button_style){
            parent::__construct('button');
            $this->add_class('group-control control');
            
            /* Add the buttons id */
            $this->attr('data-form-page-section-group-button-id', $form_data['form_page_section_group_button_id']);
