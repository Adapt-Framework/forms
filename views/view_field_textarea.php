...
namespace extensions\forms{
    ...
    class view_field_textarea extends view_field{
        ...
        public function __construct($form_data, $user_data){
            ...
            /* Create the control */
            $control = new \extensions\bootstrap_views\view_textarea($form_data['form_page_section_group_field']['name'], $form_data['form_page_section_group_field']['value'] ? $form_data['form_page_section_group_field']['value'] : $form_data['form_page_section_group_field']['default_value'], 3);
            $control->set_id();
