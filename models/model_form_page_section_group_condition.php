...
namespace adapt\forms{
    ...
    class model_form_page_section_group_condition extends model{
        
        protected $_depends_on_field_name;
        protected $_form_name;
        
        public function __construct($id = null){
            parent::__construct('form_page_section_group_condition', $id);
        }
                ...
                $sql->select('form_page_section_group_field_id')
                    ...
                    ->where(
                        new sql_and(
                            ...
                            new sql_cond('d.field_name', sql::EQUALS, sql::q($this->_depends_on_field_name))
                        )
                    );
